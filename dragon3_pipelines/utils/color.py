...
class BlackbodyColorConverter:
    ...
    def __init__(self, cache_path: str = '/p/home/jusers/wu13/juwels/project/intermediate_data/teff_to_rgb.pkl'):
        """
    ...
    def prepare_rgb_interpolator(self) -> None:
        ...
        if os.path.exists(self.cache_path):
            ...
            r_interp = interp1d(
                df_sorted['Teff'], df_sorted['R'], 
                kind='cubic', fill_value='extrapolate'
            )
            g_interp = interp1d(
                df_sorted['Teff'], df_sorted['G'], 
                kind='cubic', fill_value='extrapolate'
            )
            b_interp = interp1d(
                df_sorted['Teff'], df_sorted['B'], 
                kind='cubic', fill_value='extrapolate'
            )
