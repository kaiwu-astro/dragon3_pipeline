...
This terminology was standardized to resolve confusion where "snap" was sometimes used to refer to HDF5 files and "hdf" was sometimes used to refer to individual time points. The current definitions ensure consistency:

- **snap/snapshot** = single point in time
- **hdf5/hdf file** = file containing multiple snapshots

This clarity is essential for understanding data flow and preventing errors in data processing.
